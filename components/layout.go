	...
	<div class="video-panel-wrapper">
		...
		<div class="panel-card" style="flex: 1;">
			...
			<div id="header-compressed-stats" style="display: flex; flex-direction: column; background: rgba(30,41,59,0.5); padding: 16px 32px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); margin-top: 16px;">
				...
				<div id="hdr-reason" style="margin-top: 16px; font-size: 13px; color: #FCA5A5; text-align: center; background: rgba(239, 68, 68, 0.1); padding: 8px; border-radius: 6px; border: 1px solid rgba(239, 68, 68, 0.2);">
					--
				</div>
			</div>
		</div>
	...
	<div class="scrollable-content-wrapper">
		<div id="content-dashboard" class="tab-pane active">
			<div class="panel-card">
				<div class="panel-title" style="display: flex; justify-content: space-between; align-items: center;">
					<span>Skeleton Comparison</span>
					<div id="detected-jump-badge" style="background: rgba(59, 130, 246, 0.15); border: 1px solid rgba(59, 130, 246, 0.3); color: #60A5FA; padding: 4px 10px; border-radius: 4px; font-size: 11px; font-weight: 600; letter-spacing: 0.5px; text-transform: uppercase;">AWAITING...</div>
				</div>
				
				<div class="classification-info" style="display: none; margin-bottom: 16px; padding: 14px; background: rgba(15, 23, 42, 0.4); border-left: 3px solid #3B82F6; border-radius: 0 4px 4px 0; font-size: 13px; color: #94A3B8; line-height: 1.5;">
					<!-- Content dynamically populated by Gemini AI -->
				</div>

				<!-- ⚖️ ISU Violations Panel (Hidden per user request) -->

				<div class="comparative-skeletons">
					<div class="skeleton-box incorrect">
						<div class="skeleton-box-title">Current Execution</div>
						<canvas id="canvas-incorrect" class="compare-canvas" width="200" height="240"></canvas>
						<div id="desc-incorrect" class="correctness-desc">Awaiting analysis...</div>
					</div>
					<div class="skeleton-box correct">
						<div class="skeleton-box-title">Reference Model</div>
						<canvas id="canvas-correct" class="compare-canvas" width="200" height="240"></canvas>
						<div id="desc-correct" class="correctness-desc">Awaiting analysis...</div>
					</div>
				</div>
			</div>
